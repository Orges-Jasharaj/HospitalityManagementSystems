...
namespace HospitalityManagementSystems.Data.Seed
{
    public static class SeedData
    {
        public static async Task InitializeAsync(IServiceProvider serviceProvider)
        {
            ...
            string[] roles = new[] { RoleTypes.SuperAdmin, RoleTypes.Admin, RoleTypes.User, RoleTypes.Doctor, RoleTypes.Nurse, RoleTypes.Administrator };
